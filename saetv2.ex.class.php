...
class SaeTOAuthV2 {
	 ...
	 * @return array
	 */
	function getAuthorizeURL( $url,$display=NULL, $response_type = 'code', $state = NULL) {
		$params = array();
...
class SaeTClientV2
{
	 ...
	 * @return array
	 */
	function home_timeline( $page , $count = 200, $since_id = 0, $max_id = 0, $base_app = 0, $feature = 0 )
	{
		$params = array();
		if ($since_id) {
	...
	**/
	function short_url_expand($url_short)
	{
		...
		$params['url_short'] = (string)$url_short;
	 ...
	 * @return array
	 */
	function user_timeline_by_id( $uid , $page = 1 , $count = 50 , $since_id = 0, $max_id = 0, $feature = 0, $trim_user = 0, $base_app = 0)
	{
		$params = array();
		$params['uid']=$uid;
		if ($since_id) {
